...
export default function SearchBar({ setSearch }: { setSearch: React.Dispatch<React.SetStateAction<string>> }) {
  ...
  return (
    <form onSubmit={handleSearch} className="mt-6 relative w-1/2">
      <input
        type="text"
      ...
      />
      <button type="submit" className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-[#E2EFFF] p-3 rounded-full">
        <BiSearch
